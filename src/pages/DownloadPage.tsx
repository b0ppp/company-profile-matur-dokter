            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-white">
                ...
                <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                  Akses seluruh layanan kesehatan di Kabupaten Klaten dalam satu aplikasi mobile. Gratis untuk Android.
                </p>
        ...
        <section className="py-20 bg-gradient-to-r from-[#C41E3A] to-[#E85D75]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
              Tersedia untuk Android. Akses seluruh fitur kesehatan dalam genggaman Anda.
            </p>
